...
export function OverContractConfirmModal({
  open,
  message,
  onConfirm,
  onCancel,
  ...
  return (
    <div className="fixed inset-0 z-[60]">
      ...
      <div className="absolute left-1/2 top-1/2 w-[min(100vw-2rem,380px)] -translate-x-1/2 -translate-y-1/2 p-4">
        <div className="rounded-[28px] bg-white/90 p-5 shadow-[0_28px_70px_rgba(15,23,42,0.18)] ring-1 ring-slate-900/[0.06] backdrop-blur">
          <div className="text-[14px] font-semibold text-slate-900">Over kontrakt</div>
          <div className="mt-2 text-[12.5px] font-medium leading-relaxed text-slate-600">{message}</div>
